...
# --- 1. 網頁基本設定 ---import streamlit as st
import requests
import urllib3
from datetime import datetime, timedelta
...
# --- 1. 網頁基本設定 ---
st.set_page_config(page_title="中創園區H300空調聯防戰情室 V2.8", page_icon="❄️", layout="wide")
...
c3.metric("🌡️ 溫度加載負載", f"+{temp_penalty:.1f} kW")
...
st.set_page_config(page_title="中創園區空調聯防戰情室 V2.7", page_icon="❄️", layout="wide")
...
# --- 5. 渲染 UI ---
st.title("❄️ 中創園區空調聯防：H300行動戰情室 V2.7")

# 重點區：建議儲冰時間
st.markdown("### 🔔 健維-執行核心指令 (今晚任務)")
col_main, col_info = st.columns([2, 1])
